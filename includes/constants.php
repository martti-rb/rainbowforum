...
define('CALENDAR_DAYS_OFFSET', 14);
...
// topic title prefixes mod begin

define('TTP_GROUPS_TABLE',			$table_prefix . 'ttp_groups');
define('TTP_FORUMS_GROUPS_TABLE',	$table_prefix . 'ttp_forums_groups');
define('TTP_TOPICS_PREFIXES_TABLE',	$table_prefix . 'ttp_topics_prefixes');
define('TTP_PREFIXES_TABLE',		$table_prefix . 'ttp_prefixes');
define('TTP_PREFIXES_GROUPS_TABLE',	$table_prefix . 'ttp_prefixes_groups');

// topic title prefixes mod end 

// calendar mod begin

define('CALENDAR_PERIODS_TABLE',			$table_prefix . 'calendar_periods');  
define('CALENDAR_FORUMS_GROUPS_TABLE',		$table_prefix . 'calendar_forums_groups');
define('CALENDAR_USERS_F_FG_TABLE',			$table_prefix . 'calendar_users_f_fg');
define('CALENDAR_F_FG_TABLE',				$table_prefix . 'calendar_f_fg');

// calendar mod end 

// topic colors mod begin

define('COLOR_SETS_TABLE',			$table_prefix . 'color_sets');  

// topic colors mod end

// location tags mod begin

define('LOCATIONS_TABLE',			$table_prefix . 'locations');
define('TOPICS_LOCATIONS_TABLE',	$table_prefix . 'topics_locations');

// location tags mod end

// link mod begin

define('POSTS_LINKS_TABLE',		$table_prefix . 'posts_links');
define('LINK_TYPES_TABLE',		$table_prefix . 'link_types');

// link mod end

// circle mod begin

define('USERS_CIRCLES_TABLE',	$table_prefix . 'users_circles');
