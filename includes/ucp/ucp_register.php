...
// spam reg report mod
					...
					$logline = time() . ' ' . gmdate("M d Y H:i:s", time());
					$logline .=	' ip: ' . $user->ip . ' found in dnsbl';
					$logline .=	"\n";	
...
// bs sfs anti-spam mod begin
				include('./includes/ucp/bs_sfs_antispam.php');
// bs sfs anti-spam mod end
