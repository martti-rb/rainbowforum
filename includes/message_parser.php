...
// link mod begin
	...
	function links_error_suppress($error_en = false)
	{
...
// link mod end	
	...
	*/
	function parse($allow_bbcode, $allow_magic_url, $allow_smilies, $allow_img_bbcode = true, $allow_flash_bbcode = true, $allow_quote_bbcode = true, $allow_url_bbcode = true, $update_this_message = true, $mode = 'post')
	{
		...
		if ($mode === 'post' && $this->error_en) // links mod (insert)
		{
		...
		if ($mode === 'post' && utf8_clean_string($this->message) === '' && $this->error_en) // link mod (insert)
		{
