...
// Display Parent Forum Name Mod - Begin						
						'display_parent_forum'	=> request_var('display_parent_forum', false),
...
// auto archive mod - begin
						'auto_archive_enable'		=> request_var('auto_archive_enable', false),						
						'auto_archive_after_days'	=> request_var('auto_archive_after_days', 1),						
...
// forum color mod begin

						'forum_bg_color'			=> request_var('forum_bg_color', 50),
...
// Display Parent Forum Name Mod - Begin	
							...
							'display_parent_forum'	=> false,
							
// Display Parent Forum Name Mod - End

// calendar mod begin

							'calendar_max_periods' 			=> 4,
							'calendar_max_period_length' 	=> 135,			
							'calendar_min_start' 			=> 730,			
							'calendar_plus_start' 			=> 1826,	
							'calendar_min_gap' 				=> 1,			
							'calendar_max_gap' 				=> 40,
							'calendar_preset'				=> 0,
...
// topic title prefix mod - begin
				...
				{
					$prefix_group_selector .= '<option value="' . $row['group_id'] . '"';
					$prefix_group_selector .= ($forum_data['prefix_group_id'] == $row['group_id']) ? ' selected="selected"' : '';					
					$prefix_group_selector .= '>' . $row['group_name'] . '</option>';
				}
...
// Display Parent Forum Name Mod - Begin		
					'S_DISPLAY_PARENT_FORUM'	=> ($forum_data['display_parent_forum']) ? true : false,
// Display Parent Forum Name Mod - End

// calendar mod begin

			'VALUE_CALENDAR_MIN_START'			=> $forum_data['calendar_min_start'],
			'VALUE_CALENDAR_PLUS_START'			=> $forum_data['calendar_plus_start'],		
			'VALUE_CALENDAR_MAX_PERIOD_LENGTH'	=> $forum_data['calendar_max_period_length'],	
			'VALUE_CALENDAR_MAX_PERIODS'		=> $forum_data['calendar_max_periods'],	
			'VALUE_CALENDAR_MIN_GAP'			=> $forum_data['calendar_min_gap'],	
			'VALUE_CALENDAR_MAX_GAP'			=> $forum_data['calendar_max_gap'],
			'S_CALENDAR_PRESET'					=> $forum_data['calendar_preset'],
			
// calendar mod end

// auto archive mod - begin
					'S_AUTO_ARCHIVE_ENABLE'		=> ($forum_data['auto_archive_enable']) ? true : false,					
					'AUTO_ARCHIVE_AFTER_DAYS'	=> $forum_data['auto_archive_after_days'],					
// auto archive mod - end

// topic title prefix mod - begin
					'S_PREFIX_GROUP_OPTIONS'			=> $prefix_group_selector,			
// topic title prefix mod - end 				
				
// forum color mod begin

					'FORUM_BG_COLOR'		=> $forum_data['forum_bg_color'],
					'FORUM_COLOR'			=> $forum_color->obtain_color($forum_data['forum_bg_color'], 'forum'),
					'FORUM_COLOR_SET_ARY'	=> $forum_color->get_script_ary('forum_a'),
