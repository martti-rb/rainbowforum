...
include($phpbb_root_path . 'includes/functions_lightflower_mod.' . $phpEx);
...
// calendar mod begin
		...
		'S_CALENDAR_ENABLE'		=> $config['calendar_enable'],
		
// calendar mod end 

// map mod begin

		'U_MAP'					=> append_sid("{$phpbb_root_path}map.$phpEx"),
		'S_MAP_ENABLE'			=> $config['map_enable'],	
		
// map mod end

// analytics mod begin

		'STATCOUNTER_EN'		=> $config['statcounter_en'],
		'GOOGLE_ANALYTICS_EN'	=> $config['google_analytics_en'],
...
// auto archive mod - begin 
		else if ($time_now - $config['auto_archive_gc'] > $config['auto_archive_last_gc'])
		{	
			$cron_type = 'auto_archive';			
		} 
