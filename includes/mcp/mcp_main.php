...
// Display Parent Forum Name Mod - Begin - replace	
			...
			add_log('mod', $to_forum_id, $topic_id, 'LOG_MOVE', obtain_parent_forum_name($row) . $row['forum_name'], obtain_parent_forum_name($forum_data) . $forum_data['forum_name']);			
