...
// Display Parent Forum Name Mod - Begin - replace
				$sql = 'SELECT f1.forum_id, f1.forum_name, f1.display_parent_forum, f2.forum_name AS parent_name
					FROM ' . FORUMS_TABLE . ' f2
					LEFT JOIN ' . FORUMS_TABLE . ' f1 ON (f1.parent_id = f2.forum_id)
					WHERE ' . $db->sql_in_set('f1.forum_id', $forum_list);
				$result = $db->sql_query($sql);
				...
				$db->sql_freeresult($result);				
// Display Parent Forum Name Mod - End - replace				
/*		
