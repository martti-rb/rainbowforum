...
// Display Parent Forum Name Mod - Begin				
	...
	$forum_info['forum_name'] = obtain_parent_forum_name($forum_info) . $forum_info['forum_name'];
...
// move to archive mod - begin 
		...
		'S_CAN_MOVE_TO_ARCHIVE'	=> $auth->acl_get('m_move', $forum_id) && $config['archive_id'],
...
// calendar mod start		
				'DATE_SUFFIX'		=> (isset($calendar_data[$row['topic_moved_id']]['suffix'])) ? $calendar_data[$row['topic_moved_id']]['suffix'] : '',      					
// calendar mod end

// locations mod begin

				'LOCATION_TAG_STRING'	=> 	$topic_locations->get_tag_string($row['topic_moved_id']),

// locations mod end


// Topic Title Prefix Mod - Begin
				'TITLE_PREFIX'		=> (isset($prefix_data[$row['topic_moved_id']])) ? $prefix_data[$row['topic_moved_id']] : '',
// Topic Title Prefix Mod - End
...
// locations mod begin
				...
				'LOCATION_TAG_STRING'	=> 	$location_data[$row['topic_id']],
