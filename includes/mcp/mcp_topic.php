...
// Topic Title Prefix Mod - Begin
	$prefix_data = obtain_topic_title_prefixes($topic_info['topic_id']);
// Topic Title Prefix Mod - End	

// Calendar Mod - Begin
	$calendar_data = obtain_calendar_suffixes($topic_info['topic_id']);
// Calendar Mod - End

// locations mod begin

	$topic_locations = new topic_locations();
	$topic_locations->set_topics($topic_info['topic_id']);	
...
// Topic Title Prefix Mod - Begin
		'TITLE_PREFIX'		=> (isset($prefix_data[$topic_info['topic_id']])) ? $prefix_data[$topic_info['topic_id']] : '',
// Topic Title Prefix Mod - End

// Calendar Mod - Begin
		'DATE_SUFFIX'		=> (isset($calendar_data[$topic_info['topic_id']]['suffix'])) ? $calendar_data[$topic_info['topic_id']]['suffix'] : '',  
// Calendar Mod - End

// locations mod begin
		'LOCATION_TAG_STRING'	=> 	$topic_locations->get_tag_string($topic_info['topic_id']),
// locations mod end

// link mod begin
		'U_LINK_URL'			=> ($topic_info['topic_is_link']) ? $topic_info['topic_link_url'] : '',
		'LINK_STATUS_TEXT'		=> $topic_link->status[$topic_info['topic_link_status_id']],
		'LINK_STATUS_CLASS'		=> $topic_link->status_class[$topic_info['topic_link_status_id']],		
// link mod end
