...
--
-- Host: 
-- Generation Time: Jul 23, 2014 at 06:34 PM
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=290 ;
...
CREATE TABLE IF NOT EXISTS `phpbb_calendar_periods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1602 ;
...
--
-- Table structure for table `phpbb_color_sets`
--

CREATE TABLE IF NOT EXISTS `phpbb_color_sets` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `r0` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `g0` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `b0` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `r1` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `g1` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `b1` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `r2` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `g2` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `b2` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `r3` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `g3` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `b3` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `r4` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `g4` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `b4` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `r5` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `g5` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `b5` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `r6` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `g6` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `b6` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `r7` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `g7` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `b7` mediumint(3) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `phpbb_forums` (
  ...
  `archive_forum_is_archive` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `display_parent_forum` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `enable_calendar` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `forum_is_archive` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `forum_options` int(20) unsigned NOT NULL DEFAULT '0',
  `calendar_max_periods` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `calendar_max_period_length` mediumint(8) NOT NULL DEFAULT '200',
  `calendar_min_gap` mediumint(8) NOT NULL DEFAULT '1',
  `calendar_max_gap` mediumint(8) NOT NULL DEFAULT '30',
  `calendar_min_start` mediumint(8) NOT NULL DEFAULT '700',
  `calendar_plus_start` mediumint(8) NOT NULL DEFAULT '2000',
  `calendar_preset` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `auto_archive_enable` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `auto_archive_after_days` mediumint(8) unsigned NOT NULL DEFAULT '1',
  `prefix_group_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `locations_per_topic` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `forum_bg_color` mediumint(8) unsigned NOT NULL DEFAULT '50',
...
--
-- Table structure for table `phpbb_link_types`
--

CREATE TABLE IF NOT EXISTS `phpbb_link_types` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `is_source` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `phpbb_locations`
--

CREATE TABLE IF NOT EXISTS `phpbb_locations` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `search_1` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `search_2` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `search_3` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `search_4` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `phpbb_log` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=15805 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=220 ;
...
CREATE TABLE IF NOT EXISTS `phpbb_posts` (
  ...
  `post_link_count` mediumint(8) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`post_id`),
  KEY `forum_id` (`forum_id`),
  KEY `topic_id` (`topic_id`),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=6862 ;

-- --------------------------------------------------------

--
-- Table structure for table `phpbb_posts_links`
--

CREATE TABLE IF NOT EXISTS `phpbb_posts_links` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `link_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `post_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=3172 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1374 ;
...
--
-- Table structure for table `phpbb_regions`
--

CREATE TABLE IF NOT EXISTS `phpbb_regions` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `code` char(2) COLLATE utf8_bin NOT NULL DEFAULT '',
  `name` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `parent_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=19240 ;
...
CREATE TABLE IF NOT EXISTS `phpbb_sessions` (
  ...
  `session_header_img_id` mediumint(8) unsigned NOT NULL DEFAULT '12',
  `session_header_refresh_time` int(11) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `phpbb_spam_log`
--

CREATE TABLE IF NOT EXISTS `phpbb_spam_log` (
  `log_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `phpbb_spam_words`
--

CREATE TABLE IF NOT EXISTS `phpbb_spam_words` (
  `word_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `word_text` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `word_regex` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `word_regex_auto` tinyint(1) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`word_id`),
...
CREATE TABLE IF NOT EXISTS `phpbb_styles_imageset_data` (
  ...
  KEY `i_d` (`imageset_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=4595 ;
...
CREATE TABLE IF NOT EXISTS `phpbb_topics` (
  ...
  `archive_forum_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `topic_bg_color` mediumint(8) unsigned NOT NULL DEFAULT '54',
  `topic_bg_color_dark` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `topic_bg_color_en` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `topic_prefix_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `topic_link_count` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `topic_link_url` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `topic_is_link` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `topic_link_status_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `topic_link_type_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `topic_link_source_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `topic_link_forum_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `topic_circle_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT 'topic that is part of a circle',
  `topic_is_circle` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `topic_circle_code` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '',
  `topic_circle_code_en` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `topic_circle_hidden` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `topic_circle_public_archive` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `topic_circle_auto_archive` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `calendar_period_num` mediumint(4) unsigned NOT NULL DEFAULT '0',
  `calendar_min_year` mediumint(4) unsigned NOT NULL DEFAULT '0',
  `calendar_max_year` mediumint(4) unsigned NOT NULL DEFAULT '0',
  `location_num` mediumint(4) unsigned NOT NULL DEFAULT '0',
  `location_a1` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `location_a2` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `location_b1` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `location_c1` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `topic_thumbnail_ext` varchar(4) COLLATE utf8_bin NOT NULL DEFAULT '',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2199 ;

-- --------------------------------------------------------

--
-- Table structure for table `phpbb_topics_locations`
--

CREATE TABLE IF NOT EXISTS `phpbb_topics_locations` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `topic_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `location_a` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `location_b` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `location_c` mediumint(8) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=3873 ;
...
--
-- Table structure for table `phpbb_ttp_forums_groups`
--

CREATE TABLE IF NOT EXISTS `phpbb_ttp_forums_groups` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `group_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `forum_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `phpbb_ttp_groups`
--

CREATE TABLE IF NOT EXISTS `phpbb_ttp_groups` (
  `group_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `phpbb_ttp_prefixes`
--

CREATE TABLE IF NOT EXISTS `phpbb_ttp_prefixes` (
  `prefix_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `prefix_name` varchar(50) COLLATE utf8_bin NOT NULL,
  `requires_prefix_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `phpbb_ttp_prefixes_groups`
--

CREATE TABLE IF NOT EXISTS `phpbb_ttp_prefixes_groups` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `prefix_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `group_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=35 ;
...
--
-- Table structure for table `phpbb_ttp_topics_prefixes`
--

CREATE TABLE IF NOT EXISTS `phpbb_ttp_topics_prefixes` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `topic_id` mediumint(8) unsigned NOT NULL,
  `prefix_id` mediumint(8) unsigned NOT NULL,
  `position` mediumint(8) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=524 ;
...
CREATE TABLE IF NOT EXISTS `phpbb_users` (
  ...
  `user_hide_global` int(11) unsigned NOT NULL DEFAULT '0',
  `user_hide_announce` mediumtext COLLATE utf8_bin NOT NULL,
  `user_hide_filters` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `user_link_view` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `user_bday_day` mediumint(4) unsigned NOT NULL DEFAULT '0',
  `user_bday_month` mediumint(4) unsigned NOT NULL DEFAULT '0',
  `user_bday_year` mediumint(4) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `username_clean` (`username_clean`),
  KEY `user_birthday` (`user_birthday`),
  KEY `user_email_hash` (`user_email_hash`),
  KEY `user_type` (`user_type`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=15249 ;

-- --------------------------------------------------------

--
-- Table structure for table `phpbb_users_circles`
--

CREATE TABLE IF NOT EXISTS `phpbb_users_circles` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
