...
// lightflower mods begin

	'LIGHTFLOWER_MODS_SETTINGS'	=> 'lightflower mods settings',

// lightflower mods end
...
// Display Parent Forum Name Mod - Begin
	'DISPLAY_PARENT_FORUM'			=> 'Display parent forum\'s name',
	'DISPLAY_PARENT_FORUM_EXPLAIN'	=> 'Display parent forum\'s name on the viewforum page in title and elsewhere. This is useful when forums have the same name, but have different parent forums.',
// Display Parent Forum Name Mod - End
	
// Calendar Mod - Begin
	'ENABLE_CALENDAR'				=> 'Enable calendar function',
	'ENABLE_CALENDAR_EXPLAIN'		=> 'Topic starters can attach dates in this forum and topics can be displayed in the calendar page.',
// Calendar Mod - End	

// auto archive mod - begin
	'AUTO_ARCHIVE_ENABLE'			=> 'Auto archive enable',
	'AUTO_ARCHIVE_ENABLE_EXPLAIN'	=> 'Automatically move topics to the archive specified after the calendar period attached to the topic.',

	'AUTO_ARCHIVE_TO_FORUM'			=> 'Auto archive to forum:',
	'AUTO_ARCHIVE_TO_FORUM_EXPLAIN'	=> 'The forum to archive to.',
	
	'AUTO_ARCHIVE_AFTER_DAYS'				=> 'Auto archive after days:',
	'AUTO_ARCHIVE_AFTER_DAYS_EXPLAIN'		=> 'Days after the calendar period that the topic will be archived.',
	
// auto archive mod - end	
	
// topic title prefix mod - begin

	'PREFIX_GROUP'							=> 'Select group of prefixes',
...
// forum color mod begin
	...
	'FORUM_BG_COLOR'						=> 'forum bg color (0-640)',
	'FORUM_BG_COLOR_EXPLAIN'				=> '',
	'FORUM_BG_COLOR_TEXT_EX'				=> 'text',
