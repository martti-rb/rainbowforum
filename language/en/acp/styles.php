...
// topic color mod begin
	'IMG_ICON_BACK_TOP_DARK'		=> 'Top (dark)',
	
	'IMG_ICON_CONTACT_AIM_DARK'		=> 'AIM (dark)',
	'IMG_ICON_CONTACT_EMAIL_DARK'	=> 'Send e-mail (dark)',
	'IMG_ICON_CONTACT_ICQ_DARK'		=> 'ICQ (dark)',
	'IMG_ICON_CONTACT_JABBER_DARK'	=> 'Jabber (dark)',
	'IMG_ICON_CONTACT_MSNM_DARK'	=> 'MSNM (dark)',
	'IMG_ICON_CONTACT_PM_DARK'		=> 'Send message (dark)',
	'IMG_ICON_CONTACT_YAHOO_DARK'	=> 'YIM (dark)',
	'IMG_ICON_CONTACT_WWW_DARK'		=> 'Website (dark)',
	
	'IMG_ICON_POST_DELETE_DARK'			=> 'Delete post (dark)',
	'IMG_ICON_POST_EDIT_DARK'			=> 'Edit post (dark)',
	'IMG_ICON_POST_INFO_DARK'			=> 'Show post details (dark)',
	'IMG_ICON_POST_QUOTE_DARK'			=> 'Quote post (dark)',
	'IMG_ICON_POST_REPORT_DARK'			=> 'Report post (dark)',
	'IMG_ICON_POST_TARGET_DARK'			=> 'Minipost (dark)',
	'IMG_ICON_POST_TARGET_UNREAD_DARK'	=> 'New minipost (dark)',	
	
	'IMG_ICON_USER_ONLINE_DARK'		=> 'User online (dark)',
...
// circle mod begin
	...
	'IMG_CIRCLE'				=> 'circle',
	'IMG_CIRCLE_LOCKED'			=> 'circle locked',
	'IMG_CIRCLE_HIDDEN'			=> 'circle hidden',
	'IMG_CIRCLE_LOCKED_HIDDEN'	=> 'circle locked hidden',
	'IMG_CIRCLE_FORUM'			=> 'circle forum',	
