...
// lightflower update mod begin

	'ACP_LIGHTFLOWER_UPDATE'	=> 'lightflower update',

// lightflower update mod end

// map mod begin

	'ACP_MAP'					=> 'Map settings',

// map mod end

// display parent forum name mod - begin

	'ACP_DISPLAY_PARENT_FORUM_NAME'	=> 'Display parent forum name',
	
// display parent forum name mod - end

// topic title prefixes mod - begin

	'ACP_TOPIC_TITLE_PREFIXES'		=> 'Topic title prefixes',
	
// topic title prefixes mod - end

// archive mod - begin

	'ACP_ARCHIVE'				=> 'Archive settings',
...
// botscout and stop forum spam - begin
 
	'ACP_BOTSCOUT_AND_STOP_FORUM_SPAM'	=> 'Botscout and stop forum spam',
	
// botscout and stop forum spam - end

// hide mod begin

	'ACP_HIDE'					=> 'Hide settings',

// hide mod end

// link mod begin

	'ACP_LINK'					=> 'Link settings',

// link mod end

// circles mod begin

	'ACP_CIRCLES'				=> 'Circles settings',

// circles mod end

// location tags mod begin

	'ACP_LOCATION_TAGS'			=> 'Location tags settings',

// location tags mod end

// analytics mod begin

	'ACP_ANALYTICS'				=> 'analytics',

// analytics mod end

// rideshare mod begin

	'ACP_RIDESHARE'				=> 'rideshare',

// rideshare mod end

// topic filters mod begin

	'ACP_TOPIC_FILTERS'			=> 'topic filters',


// topic filters mod end
...
// auto archive mod - begin
	'LOG_AUTO_ARCHIVE'			=> '<strong>auto-archived topics</strong><br />» %s',	
// auto archive mod - end	
	...
	'LOG_USER_REPORT_SFS'	=> '<strong>Report to Stop Forum Spam:</strong><br />» %s',	
